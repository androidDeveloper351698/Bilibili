    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_PREPARED:
                ...
                Log.i("json","media prepare");
                return;

            case MEDIA_PLAYBACK_COMPLETE:
                player.notifyOnCompletion();
                player.stayAwake(false);
                Log.i("json","media playback complete");
                return;
            ...
            case MEDIA_BUFFERING_UPDATE:
                ...
                Log.i("json","arg1:"+msg.arg1);
                Log.i("json","arg2:"+msg.arg2);
                player.notifyOnBufferingStateChange(msg); //我自己添加的监听 用来获取视频缓冲信息 用来同步弹幕数据

                return;

            case MEDIA_SEEK_COMPLETE:
                player.notifyOnSeekComplete();
                Log.i("json","media seek complete");
                return;
            ...
            case MEDIA_SET_VIDEO_SIZE:
                ...
                Log.i("json","media set video size");
                return;
            ...
            case MEDIA_INFO:
                ...
                Log.i("json","media info:  arg1:"+msg.arg1+",arg2:"+msg.arg2);
                return;
            case MEDIA_TIMED_TEXT:
                // do nothing
                Log.i("json","media timed text");
                break;
            ...
            case MEDIA_SET_VIDEO_SAR:
                ...
                player.notifyOnVideoSizeChanged(player.mVideoWidth, player.mVideoHeight,
                        player.mVideoSarNum, player.mVideoSarDen);
                Log.i("json","media set video sar");
                break;
