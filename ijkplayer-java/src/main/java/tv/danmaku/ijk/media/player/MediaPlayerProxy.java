...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    public void setOnBufferingStateChangeListener(OnBufferingStateChangeListener listener) {
        if(listener!=null){
            final OnBufferingStateChangeListener finalListener = listener;
            mBackEndMediaPlayer.setOnBufferingStateChangeListener(new OnBufferingStateChangeListener() {
                @Override
                public void onBufferingStateChange(IMediaPlayer mp, Message msg) {
                    finalListener.onBufferingStateChange(mp,msg);
                }
            });
        }else {
            mBackEndMediaPlayer.setOnBufferingStateChangeListener(null);
        }
    }
