...
public class VideoCardView extends CardView {
    ...
    public VideoCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Drawable playCountDrawable = getResources().getDrawable(R.drawable.card_playcount_item_group);
        ...
        Drawable commentCountDrawable = getResources().getDrawable(R.drawable.card_danmacount_item_group);
