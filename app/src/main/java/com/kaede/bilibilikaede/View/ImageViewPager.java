...
import com.kaede.bilibilikaede.MyApplication;
...
//    private static Handler mHandler = new Handler();
    ...
    private class AutoSwitch implements Runnable{
        ...
        public void run() {
            ...
            MyApplication.getMainHandler().postDelayed(this,switchTime);//递归调用自己的run方法
        }

        public void start(){
            stop();
            MyApplication.getMainHandler().postDelayed(this,switchTime);
        }
