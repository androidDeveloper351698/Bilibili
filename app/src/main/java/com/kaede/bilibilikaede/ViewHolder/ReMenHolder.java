...
public class ReMenHolder extends RecyclerView.ViewHolder {
    ...
    public ReMenHolder(View itemView, Context context,int category) {
        super(itemView);
    ...
    public void initData(){
        switch (mCategory){
            case Constant.FAN_JU:
                ...
                titleText.setCompoundDrawablesWithIntrinsicBounds(R.drawable.hot_item_group,0,0,0);
                enterText.setText("排行榜");
                enterText.setBackgroundResource(R.drawable.item_group_right_more);
                enterText.setCompoundDrawablesWithIntrinsicBounds(R.drawable.rank_item_group,0,0,0);
    ...
    private void changeItem(){
        ...
        videoDetails.clear();
        ArrayList<VideoDetail> list = dao.queryVideoByCategory(VideoDao.TYPE_MAIN_HOT, mCategory, VideoDao.FLAG_RANDOM);
